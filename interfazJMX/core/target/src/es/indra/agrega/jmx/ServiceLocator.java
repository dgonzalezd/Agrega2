...
public class ServiceLocator
{
    ...
    /**
     * Gets an instance of {@link es.indra.agrega.jmx.PropiedadJmxService}.
     */
    public final es.indra.agrega.jmx.PropiedadJmxService getPropiedadJmxService()
    {
        return (es.indra.agrega.jmx.PropiedadJmxService)
            getContext().getBean("propiedadJmxService");
    }

    /**
     * Gets an instance of {@link es.pode.configuracionPlataforma.servicios.SrvPropiedadService}.
     */
    public final es.pode.configuracionPlataforma.servicios.SrvPropiedadService getSrvPropiedadService()
    {
        return (es.pode.configuracionPlataforma.servicios.SrvPropiedadService)
            getContext().getBean("srvPropiedadService");
    }
